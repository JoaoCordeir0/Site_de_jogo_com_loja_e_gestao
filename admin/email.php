    ...
    <script type="text/javascript" languege="javascript">
        $(document).ready(function() {
            $('#usuarios').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "backend/processa_datatable_email.php",
                    "type": "POST"
                }
            });
        });
        ...
        <section class="home-section">
            <div class="home-content">
                ...
                <div class="container-fluid" style="margin:30px auto auto auto;">
                        ...
                        <table id="usuarios" class="display" style="width:100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="corTH">Tema do e-mail</th>
                                    <th class="corTH">Data</th>
                                    <th class="corTH">IP de quem enviou</th>
                                    <th class="corTH">Destinatario</th>                                    
                                    <th class="corTH"></th>
                                </tr>
                            </thead>
                        </table>
                    ...
                    <?php include("include/deleta_registros_email.php") ?>
