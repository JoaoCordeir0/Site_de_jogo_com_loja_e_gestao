    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <p style="margin-bottom:15px;"><span style="font-size: 14pt;"><b>Carrinho de compras</b></span> <a style="float:right; color:black;" href="" onclick="hideMessage()"><i class="fas fa-times-circle"></i></a></p>
                <?php       
